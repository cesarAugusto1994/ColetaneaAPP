...
import { StyleSheet, SafeAreaView, TouchableHighlight, TextInput, View } from 'react-native';
      ...
      <Block>
        ...
        <Picker
          ...
          onValueChange={(itemValue, itemIndex) => {
            ...
            {
              categories.map(category => <Picker.Item key={category.id} label={`${category.colecao_id && category.colecao_id.nome}: ${category.nome}`} value={category.id} />)
            }
        </Picker>
			</Block>
