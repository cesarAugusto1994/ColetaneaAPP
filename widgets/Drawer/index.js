...
const menus = [
	...
	{ name: 'songs', title: 'Mídias', screen: SCREENS.SONGS },
	{ name: 'favourite', title: 'Favoritos', screen: SCREENS.FAVOURITE },
	{ name: 'recent', title: 'Tocadas recentemente', screen: SCREENS.RECENT },
...
const Index = ({
	...
	useAssets([require('../../assets/player/logo.png')]);
			...
			<LinearGradient style={styles.container} colors={['#C07037', '#C55234']}>
				<View style={styles.menuContainer}>
					<Animatable.View style={styles.header} animation={active ? 'slideInDown' : 'slideOutUp'} duration={2000}>
						<Image style={styles.logo} source={require('../../assets/player/logo.png')} />
